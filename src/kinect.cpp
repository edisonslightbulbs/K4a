...
void Kinect::pclImage(
    const std::shared_ptr<std::vector<float>>& sptr_points) const
{
...
//     auto* k4aImageData =
//     (k4a_float2_t*)(void*)k4a_image_get_buffer(m_xyTable); auto* pclData =
//     (k4a_float3_t*)(void*)k4a_image_get_buffer(m_fastPclImage);
//
//     int numPoints = 0;
